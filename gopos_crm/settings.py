"""
Django settings for GOPOS CRM project.
"""
...
# If PostgreSQL URL is provided (Zeabur), use it
if os.environ.get('DATABASE_URL'):
    DATABASES = {
        'default': {
            'ENGINE': 'django.db.backends.postgresql',
            'NAME': os.environ.get('PGDATABASE', 'gopos_crm'),
...
DEFAULT_FROM_EMAIL = 'GOPOS CRM <noreply@gopos.hk>'

# PWA Settings
PWA_APP_NAME = 'GOPOS CRM'
PWA_APP_SHORT_NAME = 'GOPOS'
PWA_APP_DESCRIPTION = '創域科技客戶關係管理系統'
